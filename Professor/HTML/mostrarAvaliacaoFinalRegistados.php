...
<head>
    <title>Consultar Avalições Finais</title>
    ...
    <script>
        ...
        function limparFiltros() {
            ...
            xhttp.open("GET", "../BD/AvaliacaoFinal/limparFiltros.php", true);
            xhttp.send();
        ...
        function filtros() {
            ...
            xhttp.open("GET", "../BD/AvaliacaoFinal/filtros.php?filtro=" + valorSelect + "&valorInput=" + valorInput, true);
            xhttp.send();
        }
        ...
        function detailsNome(id) {
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("modalAvaliacoes").innerHTML = this.responseText;
                }
            };
            xhttp.open("GET", "../BD/AvaliacaoFinal/details.php?id=" + id, true);
            xhttp.send();
        }
        ...
        function deleteId() {
            ...
            xhttp.open("GET", "../BD/AvaliacaoFinal/delete.php?id=" + idEliminar, true);
            xhttp.send();
        }
...
<body onload="limparFiltros(); verifyUser()">
    <div class="container-fluid">
        ...
        <br><br><br><br>
        <div class="row">
            <h1 style="margin-left:10px">Avaliação Final de Estágio</h1>
            <div class="col">
                <div class="float-right">
                    <button type="button" class="btn btn-success" onclick="window.location='registarAvaliacaoFinalEstagio.php'">Adicionar Novo &#10010</button>
                </div>
            </div>
        </div>
        <br>
        <div class="row">
            ...
            <select id="filtro" class="form-control" style="width:250px" onchange="inputVisible()">
                ...
                <option value="CF">Classificação Final</option>
            </select>
            ...
            <div class="modal" id="myModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="modalAvaliacoes">
                        </div>
