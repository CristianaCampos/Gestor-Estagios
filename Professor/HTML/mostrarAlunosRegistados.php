...
<head>
    ...
    <script>
        ...
        function limparFiltros() {
            ...
            xhttp.open("GET", "../BD/Alunos/limparFiltros.php", true);
            xhttp.send();
        ...
        function filtros() {
            ...
            xhttp.open("GET", "../BD/Alunos/filtros.php?filtro=" + valorSelect + "&valorInput=" + valorInput, true);
            xhttp.send();
        }
        ...
        function detailsNome(id) {
            ...
            xhttp.open("GET", "../BD/Alunos/details.php?id=" + id + "&tipo=nome", true);
            xhttp.send();
        }

        function detailsTurma(id) {
            //turma
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("turma-modal").innerHTML = this.responseText;
                }
            };
            xhttp.open("GET", "../BD/Alunos/details.php?id=" + id + "&tipo=idTurma", true);
            xhttp.send();
        }

        function detailsCodigo(id) {
            //codigo aluno
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("codigo-modal").innerHTML = this.responseText;
                }
            };
            xhttp.open("GET", "../BD/Alunos/details.php?id=" + id + "&tipo=codigoAluno", true);
            xhttp.send();
        }
        ...
        function detailsData(id) {
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("data-modal").innerHTML = this.responseText;
                }
            };
            xhttp.open("GET", "../BD/Alunos/details.php?id=" + id + "&tipo=dataNascimento", true);
            xhttp.send();
        }
        ...
        function detailsMorada(id) {
            ...
            xhttp.open("GET", "../BD/Alunos/details.php?id=" + id + "&tipo=morada", true);
            xhttp.send();
        }
        ...
        function detailsLocalidade(id) {
            ...
            xhttp.open("GET", "../BD/Alunos/details.php?id=" + id + "&tipo=localidade", true);
            xhttp.send();
        }
        ...
        function detailsEmail(id) {
            ...
            xhttp.open("GET", "../BD/Alunos/details.php?id=" + id + "&tipo=email", true);
            xhttp.send();
        }

        function detailsCC(id) {
            //CC
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("cc-modal").innerHTML = this.responseText;
                }
            };
            xhttp.open("GET", "../BD/Alunos/details.php?id=" + id + "&tipo=cc", true);
            xhttp.send();
        }
        ...
        function detailsContacto(id) {
            ...
            xhttp.open("GET", "../BD/Alunos/details.php?id=" + id + "&tipo=telefone", true);
            xhttp.send();
        }
        ...
        function deleteId() {
            ...
            xhttp.open("GET", "../BD/Alunos/delete.php?id=" + idEliminar, true);
            xhttp.send();
        }
...
<body onload="limparFiltros(); verifyUser()">
    <div class="container-fluid">
        ...
        <br><br><br><br>
        <div class="row">
            <h1 style="margin-left:10px">Alunos</h1>
            <div class="col">
                <div class="float-right">
                    <button type="button" class="btn btn-success" onclick="window.location='registarAlunos.php'">Adicionar Novo &#10010</button>
                </div>
            </div>
        </div>
        <br>
        <div class="row">
            ...
            <select id="filtro" class="form-control" style="width:250px" onchange="inputVisible()">
                ...
                <option value="codigoAluno">Código do Aluno</option>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <hr>
                            <b>Turma</b>
                            <div id="turma-modal"></div>
                            <hr>
                            <b>Código do Aluno</b>
                            <div id="codigo-modal"></div>
                            <hr>
            ...
            <div class="modal fade" id="myModalErro">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p><i class="fas fa-exclamation-triangle"></i> Ocorreu um erro. Esse aluno já está inserido noutros registos.</p>
                        </div>
