...
<head>
    ...
    <script>
        function limparFiltros() {
            ...
            xhttp.open("GET", "../BD/Cursos/limparFiltros.php", true);
            xhttp.send();
        ...
        function filtros() {
            ...
            xhttp.open("GET", "../BD/Cursos/filtros.php?filtro=" + valorSelect + "&valorInput=" + valorInput, true);
            xhttp.send();
        }
        ...
        function detailsNome(id) {
            ...
            xhttp.open("GET", "../BD/Cursos/details.php?id=" + id + "&tipo=nome", true);
            xhttp.send();
        }
        ...
        function deleteId() {
            ...
            xhttp.open("GET", "../BD/Cursos/delete.php?id=" + idEliminar, true);
            xhttp.send();
        }
...
<body onload="limparFiltros(); verifyUser()">
    <div class="container-fluid">
        ...
        <br><br><br><br>
        <div class="row">
            <h1 style="margin-left:10px">Cursos</h1>
            <div class="col">
                <div class="float-right">
                    <button type="button" class="btn btn-success" onclick="window.location='registarCursos.php'">Adicionar Novo &#10010</button>
                </div>
            </div>
        </div>
        <br>
            ...
            <div class="modal fade" id="myModalErro">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p><i class="fas fa-exclamation-triangle"></i> Ocorreu um erro. Esse curso já está inserido noutros registos.</p>
                        </div>
