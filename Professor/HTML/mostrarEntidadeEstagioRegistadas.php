...
<head>
    <title>Consultar Entidades de Estágio</title>
    ...
    <script>
        ...
        function limparFiltros() {
            ...
            xhttp.open("GET", "../BD/EntidadesEstagio/limparFiltros.php", true);
            xhttp.send();
        ...
        function filtros() {
            ...
            xhttp.open("GET", "../BD/EntidadesEstagio/filtros.php?filtro=" + valorSelect + "&valorInput=" + valorInput, true);
            xhttp.send();
        }
        ...
        function detailsNome(id) {
            ...
            xhttp.open("GET", "../BD/EntidadesEstagio/details.php?id=" + id + "&tipo=nome", true);
            xhttp.send();
        }
        ...
        function detailsMorada(id) {
            ...
            xhttp.open("GET", "../BD/EntidadesEstagio/details.php?id=" + id + "&tipo=morada", true);
            xhttp.send();
        }
        ...
        function detailsLocalidade(id) {
            ...
            xhttp.open("GET", "../BD/EntidadesEstagio/details.php?id=" + id + "&tipo=localidade", true);
            xhttp.send();
        }
        ...
        function detailsEmail(id) {
            ...
            xhttp.open("GET", "../BD/EntidadesEstagio/details.php?id=" + id + "&tipo=email", true);
            xhttp.send();
        }
        ...
        function detailsContacto(id) {
            ...
            xhttp.open("GET", "../BD/EntidadesEstagio/details.php?id=" + id + "&tipo=contacto", true);
            xhttp.send();
        }

        function detailsNIF(id) {
            //nif
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("nif-modal").innerHTML = this.responseText;
                }
            };
            xhttp.open("GET", "../BD/EntidadesEstagio/details.php?id=" + id + "&tipo=nif", true);
            xhttp.send();
        }
        ...
        function deleteId() {
            ...
            xhttp.open("GET", "../BD/EntidadesEstagio/delete.php?id=" + idEliminar, true);
            xhttp.send();
        }
...
<body onload="limparFiltros(); verifyUser()">
    <div class="container-fluid">
        ...
        <br><br><br><br>
        <div class="row">
            <h1 style="margin-left:10px">Entidades de Estágio</h1>
            <div class="col">
                <div class="float-right">
                    <button type="button" class="btn btn-success" onclick="window.location='registarEntidadeEstagio.php'">Adicionar Novo &#10010</button>
                </div>
            </div>
        </div><br>
        <div class="row">
        ...
        <div id="modalErro">
            <div class="modal" id="myModalErro">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <p><i class="fas fa-exclamation-triangle"></i> Ocorreu um erro. Essa entidade de estágio já está inserida noutros registos.</p>
                        </div>
