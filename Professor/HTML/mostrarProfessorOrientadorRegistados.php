...
<head>
    <title>Consultar Professores Orientadores</title>
    ...
    <script>
        ...
        function limparFiltros() {
            ...
            xhttp.open("GET", "../BD/ProfessoresOrientadores/limparFiltros.php", true);
            xhttp.send();
        ...
        function filtros() {
            ...
            xhttp.open("GET", "../BD/ProfessoresOrientadores/filtros.php?filtro=" + valorSelect + "&valorInput=" + valorInput, true);
            xhttp.send();
        }
        ...
        function detailsNome(id) {
            ...
            xhttp.open("GET", "../BD/ProfessoresOrientadores/details.php?id=" + id + "&tipo=nome", true);
            xhttp.send();
        }
        ...
        function detailsEmail(id) {
            ...
            xhttp.open("GET", "../BD/ProfessoresOrientadores/details.php?id=" + id + "&tipo=email", true);
            xhttp.send();
        }
        ...
        function detailsContacto(id) {
            ...
            xhttp.open("GET", "../BD/ProfessoresOrientadores/details.php?id=" + id + "&tipo=telefone", true);
            xhttp.send();
        }
        ...
        function detailsCurso(id) {
            ...
            xhttp.open("GET", "../BD/ProfessoresOrientadores/details.php?id=" + id + "&tipo=idCurso", true);
            xhttp.send();
        }
        ...
        function deleteId() {
            ...
            xhttp.open("GET", "../BD/ProfessoresOrientadores/delete.php?id=" + idEliminar, true);
            xhttp.send();
        }
...
<body onload="limparFiltros(); verifyUser()">
    <div class="container-fluid">
        ...
        <br><br><br><br>
        <div class="row">
            <h1 style="margin-left:10px">Professores Orientadores</h1>
            <div class="col">
                <div class="float-right">
                    <button type="button" class="btn btn-success" onclick="window.location='registarProfessorOrientador.php'">Adicionar Novo &#10010</button>
                </div>
            </div>
        </div><br>
        <div class="row">
            ...
            <div class="modal fade" id="myModalErro">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p><i class="fas fa-exclamation-triangle"></i> Ocorreu um erro. Esse professor orientador já está inserido noutros registos.</p>
                        </div>
